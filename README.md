...
無料で遊べるブラウザ日本語タイピングゲーム。右から迫るゾンビを、頭上の単語をローマ字で打ち切って撃ち倒す。夜明けまで生き延びる通常モード、限界まで挑むエンドレスモード、難易度別オンラインランキングに対応。
...
- インストール不要。PCブラウザとキーボードだけでプレイ可能
- 日本語の単語をローマ字入力で練習できるタイピングトレーニング
- イージー / ノーマル / ハード / ハードコア / エンドレスの難易度
- リザルトのXシェアと難易度別オンラインランキング
